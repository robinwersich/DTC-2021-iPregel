---
title: "IMDb Node Importance Measure Analysis"
...
In the IMDb actors (2011) dataset actors registered in the IMDb database are represented as nodes. Two actors are connected with an edge if they are credited in the same movie.
...
id_mapping = read.csv("../results/hollywood-2011-ids.txt", sep=",")
