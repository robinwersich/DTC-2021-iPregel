...
cc <- as.data.frame(read.csv("../results/networkit_closeness_centrality_higgs-twitter_reversed.txt", sep="\t", header=FALSE))
colnames(cc) <- c("ID", "CC")
cc$ID <- cc$ID + 1


f_count = as.data.frame(read.csv("../results/follower_count_higgs-social-network.txt", sep=" ", header=FALSE))
